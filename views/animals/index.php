        ...
        <div class="row">
            <aside class="col-md-4 col-lg-3 mb-3">
                <form class="bg-light p-3 rounded shadow-sm">
                    ...
                    <select name="adopted" class="form-select mb-2">
                        <option value="0" <?= !$request->adopted ? 'selected' : '' ?>>
                            Лише доступні
                        </option>
                        <option value="1" <?= $request->adopted ? 'selected' : '' ?>>
                            Лише усиновлені
                        </option>
                    </select>
                    ...
                    <select class="form-select mb-3" id="direction" name="direction">
                        <option value="asc" <?= $request->direction == 'ASC' ? 'selected' : '' ?>>За зростанням ↑
                        </option>
                        <option value="desc" <?= $request->direction == 'DESC' ? 'selected' : '' ?>>За спаданням ↓
                        </option>
                    </select>
