...
abstract class BaseListRequest
{
    ...
    public function sanitize(): void
    {
        ...
        $this->convertedDirection = strtoupper($this->direction) === SQLOrderDirection::Descending->value ? SQLOrderDirection::Descending : SQLOrderDirection::Ascending;
        ...
        if (!in_array($this->perPage, static::PER_PAGE_CHOICES, true)) {
            $this->perPage = static::PER_PAGE_CHOICES[0];
        }
